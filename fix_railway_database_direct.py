#!/usr/bin/env python3
"""
Direct fix for Railway database using provided connection details
"""
...
DATABASE_URL = "postgresql://postgres:dKEIiFYGNmoUPbHghPYdyFzKZzQQnmCO@ballast.proxy.rlwy.net:54315/railway"

def fix_database_schema():
    """Fix the database schema column length issues"""
    print(f"🔧 FIXING RAILWAY DATABASE SCHEMA COLUMN LENGTH ISSUES")
    print("=" * 60)
    print(f"🔗 Connecting to: ballast.proxy.rlwy.net:54315/railway")
    
    try:
        # Create engine with the provided Railway URL
