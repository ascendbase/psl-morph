#!/usr/bin/env python3
"""
Fix database column length issue for facial evaluation
"""
...
def get_database_url():
    ...
    # Default local
    return 'postgresql://postgres:password@localhost:5432/morph_app'

def fix_database_schema():
    """Fix the database schema column length issues"""
    database_url = get_database_url()
    print(f"🔧 FIXING DATABASE SCHEMA COLUMN LENGTH ISSUES")
    print("=" * 60)
