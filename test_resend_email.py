...
This script tests the email verification system using Resend API
"""
...
def test_environment_variables():
    ...
    if missing_vars:
        ...
        print("See RESEND_EMAIL_SETUP_GUIDE.md for instructions.")
        return False
...
def test_api_connection():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if domains.get('data'):
                print(f"📧 Available domains: {len(domains['data'])}")
            return True
...
def main():
    """Main test function"""
    print("🧪 Resend Email Verification System Test")
    print("=" * 50)
    ...
    print("3. If everything looks good, deploy to Railway with your Resend credentials")
    print("4. Update Railway environment variables with your Resend API key")
    print("5. Test the complete registration flow on your deployed app")
