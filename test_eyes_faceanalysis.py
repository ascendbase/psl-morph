"""
Test script for Eyes + Eyebrows FaceAnalysis workflow
This tests the new ComfyUI_FaceAnalysis node for feature-specific targeting
"""
...
def test_eyes_faceanalysis_workflow():
    """Test the eyes + eyebrows FaceAnalysis workflow"""
    
    # ComfyUI settings
    comfyui_url = "http://127.0.0.1:8188"
    
    print("🧪 Testing Eyes + Eyebrows FaceAnalysis Workflow")
    print("=" * 50)
    
    # Load workflow
    workflow_path = "comfyui_workflows/workflow_eyes_faceanalysis.json"
    ...
    try:
        ...
        if "12" not in outputs:  # SaveImage node
        ...
        # Save the result
        output_path = f"test_output_eyes_faceanalysis.png"
        ...
        print("🔍 FaceSegmentation Node: eyes,eyebrows")
        print("📊 Confidence: 0.5")
        print("� Target Parts: eyes,eyebrows")
        print("📏 Expand: 10 pixels")
        print("🌫️ Blur: 5 radius")
        
        print("\n🎉 Eyes + Eyebrows FaceAnalysis test completed successfully!")
...
if __name__ == "__main__":
    print("🧪 ComfyUI FaceAnalysis Eyes Test")
    print("=" * 40)
    print("This tests the new ComfyUI_FaceAnalysis workflow")
    print("for targeting eyes + eyebrows specifically")
    print()
    ...
    success = test_eyes_faceanalysis_workflow()
    
    if success:
        print("\n🎉 SUCCESS! The FaceAnalysis workflow works!")
        print("✅ Eyes + eyebrows targeting is functional")
        print("🚀 Ready to create workflows for other facial features")
    else:
